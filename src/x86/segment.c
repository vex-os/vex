...
static int init_x86_segment(void)
{
    ...
    set_entry_16(SEGMENT_KERN_CODE_16, 0x00000000, 0xFFFF, code_flags | GDT_RING_0);
    set_entry_16(SEGMENT_KERN_DATA_16, 0x00000000, 0xFFFF, data_flags | GDT_RING_0);
    set_entry_32(SEGMENT_KERN_CODE_32, 0x00000000, 0xFFFFF, code_flags | GDT_RING_0);
    set_entry_32(SEGMENT_KERN_DATA_32, 0x00000000, 0xFFFFF, data_flags | GDT_RING_0);
    set_entry_64(SEGMENT_KERN_CODE_64, code_flags | GDT_RING_0);
    set_entry_64(SEGMENT_KERN_DATA_64, data_flags | GDT_RING_0);
    set_entry_64(SEGMENT_USER_CODE_64, code_flags | GDT_RING_3);
    set_entry_64(SEGMENT_USER_DATA_64, data_flags | GDT_RING_3);
    ...
    asm volatile(__string_va(
        ...
        movw %%ax, %%gs;
        movw %%ax, %%ss;
    )::"a"(SEGMENT_SELECTOR(SEGMENT_KERN_DATA_64, 0, 0)));
    ...
    pr_inform("x86_segment: gdtr.size=%zu", (size_t)(gdtr.size));
    pr_inform("x86_segment: gdtr.offset=%p", (void *)(gdtr.offset));

    return EOK;
}
initcall_tier_0(x86_segment, init_x86_segment);
