...
#ifndef __INCLUDE_KANERU_INIT_H__
#define __INCLUDE_KANERU_INIT_H__
#include <kaneru/cdefs.h>

typedef void (*initcall_t)(void);

/* defined in kern/init_list.c */
/* generated via scripts/init_list.sh */
