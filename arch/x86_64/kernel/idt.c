...
void set_idt_entry_kern(unsigned int vector, int is_trap, const void* restrict pfn)
{
    ...
    if(vector < IDT_SIZE) {
        ...
        entry->flags = is_trap ? IDT_TRAP : IDT_INTR;
...
void set_idt_entry_user(unsigned int vector, int is_trap, const void* restrict pfn)
{
    struct idt_entry* entry;
...
void init_idt(void)
{
    ...
    set_idt_entry_kern(0x00, 1, &x86_isr_00);
    set_idt_entry_kern(0x01, 1, &x86_isr_01);
    set_idt_entry_kern(0x02, 1, &x86_isr_02);
    set_idt_entry_kern(0x03, 1, &x86_isr_03);
    set_idt_entry_kern(0x04, 1, &x86_isr_04);
    set_idt_entry_kern(0x05, 1, &x86_isr_05);
    set_idt_entry_kern(0x06, 1, &x86_isr_06);
    set_idt_entry_kern(0x07, 1, &x86_isr_07);
    set_idt_entry_kern(0x08, 1, &x86_isr_08);
    set_idt_entry_kern(0x09, 1, &x86_isr_09);
    set_idt_entry_kern(0x0A, 1, &x86_isr_0A);
    set_idt_entry_kern(0x0B, 1, &x86_isr_0B);
    set_idt_entry_kern(0x0C, 1, &x86_isr_0C);
    set_idt_entry_kern(0x0D, 1, &x86_isr_0D);
    set_idt_entry_kern(0x0E, 1, &x86_isr_0E);
    set_idt_entry_kern(0x0F, 1, &x86_isr_0F);
    set_idt_entry_kern(0x10, 1, &x86_isr_10);
    set_idt_entry_kern(0x11, 1, &x86_isr_11);
    set_idt_entry_kern(0x12, 1, &x86_isr_12);
    set_idt_entry_kern(0x13, 1, &x86_isr_13);
    set_idt_entry_kern(0x14, 1, &x86_isr_14);
    set_idt_entry_kern(0x15, 1, &x86_isr_15);
    set_idt_entry_kern(0x16, 1, &x86_isr_16);
    set_idt_entry_kern(0x17, 1, &x86_isr_17);
    set_idt_entry_kern(0x18, 1, &x86_isr_18);
    set_idt_entry_kern(0x19, 1, &x86_isr_19);
    set_idt_entry_kern(0x1A, 1, &x86_isr_1A);
    set_idt_entry_kern(0x1B, 1, &x86_isr_1B);
    set_idt_entry_kern(0x1C, 1, &x86_isr_1C);
    set_idt_entry_kern(0x1D, 1, &x86_isr_1D);
    set_idt_entry_kern(0x1E, 1, &x86_isr_1E);
    set_idt_entry_kern(0x1F, 1, &x86_isr_1F);
    ...
    kprintf(KP_INFORM, "idt: idtr.size=%zu idtr.offset=%p", (size_t)(idtr.size), (const void*)(idtr.offset));
}
